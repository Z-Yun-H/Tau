...
| repo root                       | `docs/` (workspace member `@tau/docs`, private)                                                                                                                       | the public documentation site — VitePress, zh (default) + en locales; content decomposed from the product feature map (issue #111); authoring workflow: `.claude/skills/tau-docs`; NOT part of the `pnpm build` gate — build explicitly with `pnpm docs:build`                 |
