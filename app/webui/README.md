...
**provider setup (v0.7.0) — pick a provider, the endpoint is looked up
...
**privacy masking (v0.7.0) — the key input is a password field; an
...
**viewport lock (v0.7.0) — the page is exactly one viewport tall at
