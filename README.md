...
| `tau web`      | local web interface (v0.6.0: composer `/` command menu, conversation threads, image attachments with server-side magic-number validation, sandboxed HTML previews + native PDF/image viewing) |
